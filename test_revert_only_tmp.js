...
function linha(vals){ const row = new Array(header.length).fill(null); Object.keys(vals).forEach(k => { row[header.indexOf(k)] = vals[k]; }); return row; }
...
console.log('total:', recs.length, '(esperado 3)');
