...
assert(avTipoEl.options.length === 3, 'combobox tem 3 opcoes');
assert(Array.from(avTipoEl.options).map(o=>o.value).join(',') === 'novo,portabilidade,titularidade', 'ordem das opcoes: novo, portabilidade, titularidade');
